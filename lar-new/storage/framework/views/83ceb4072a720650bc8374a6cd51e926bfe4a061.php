<?php $__env->startSection('title', 'Добавить ресурс'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.source.store')); ?>">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-8">
                <input id="sourceTitle" type="text" class="form-control" name="title" value="<?php echo e(old('title')); ?>" autofocus>
            </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-8">
                <input id="sourceLink" type="text" class="form-control" name="source" value="<?php echo e(old('source')); ?>" autofocus>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/resources/views/admin/source/create.blade.php ENDPATH**/ ?>