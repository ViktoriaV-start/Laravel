                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('admin.index')?'active':'' }}" aria-current="page" href="{{ route('admin.index') }}">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door mb-2" viewBox="0 0 16 16">
...
{{--                                <a class="nav-link active" href="{{ route('admin.category.create') }}">--}}
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">
                                    ...
                                    <svg width="20" height="20" fill="currentColor" class="bi bi-images mb-1" viewBox="0 0 16 16">
